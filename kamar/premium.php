...
<h1 class="title">Premium</h1>
 ...
 <!-- RoomDetails -->
            <div id="RoomDetails" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active"><img src="../images/photos/31.jpg" class="img-responsive" alt="slide"></div>
...
<div class="room-features spacer">
  <div class="row">
    ...
    <p>PREMIUM merupakan type kamar yang terbaik karena memiliki fasilitas yang lengkap dan memuaskan</p>
    <p></p>
    </div>
    ...
    <?php
      ...
      $sql = mysqli_query($conn, "select * from fasilitas_kamar where type_kamar = 'premium' ");
    ...
    <div class="col-sm-7 col-md-3">
      <div class="size-price">Harga<span>Rp.150.000,00</span></div>
    </div>
  </div>
</div>
