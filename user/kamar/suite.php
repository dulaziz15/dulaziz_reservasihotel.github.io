...
<h1 class="title">Suite</h1>
 ...
 <!-- RoomDetails -->
            <div id="RoomDetails" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active"><img src="../../images/photos/1q.jpg" class="img-responsive" alt="slide"></div>
...
<div class="room-features spacer">
  <div class="row">
    ...
    <p>SUITE merupakan type kamar yang terbaik karena memiliki fasilitas yang lengkap dan memuaskan</p>
    <p></p>
    </div>
    ...
    <?php
      ...
      $sql = mysqli_query($conn, "select * from fasilitas_kamar where type_kamar = 'suite' ");
