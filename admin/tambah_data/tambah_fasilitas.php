              ...
              <div class="card-body">
                  <div class="form-group">
                    ...
                    // MEMBUAT ID PENGUNJUNG OTOMATIS
                        $sql = mysqli_query($conn, "select max(substr(id_fasilitas,3)) as id from fasilitas");
                         while ($data = mysqli_fetch_array($sql)) {
                               $no = (int)$data['id'];
                            $no = $no + 1;
                            $no = "F-" . sprintf("%03s", $no); ?>
                              <input type="text" value="<?php echo $no;
                                                      } ?>" class="form-control" id="id_fasilitas" name="id_fasilitas" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Jumlah Fasilitas">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Keadaan</label>
                    <input type="text" class="form-control" id="keadaan" name="keadaan" placeholder="Keadaan">
                  </div>
                <div class="form-group">
