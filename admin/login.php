...
<head>
    ...
    <title>Login ADMIN APITA HOTEL</title>
    <style>
...
<body>
    <div class="wrapper">
    <div class="logo"> <img src="dist/img/9.png" alt=""> </div>
    <div class="text-center mt-4 name"> Admin</div>
    <div class="text-center mt-4 name">APITA HOTEL</div>
    <!-- FORM LOGIN -->
    <form class="p-3 mt-3" action="controller/login.php?aksi=login" method="POST">
